...
export class ListComponent extends BaseComponent implements OnInit {
  ...
  displayedColumns: string[] = ['Name', 'Stock', 'Price', 'CreatedDate', 'UpdatedDate', 'ImageUpload', 'Edit', 'Delete' ];
  ...
  async getProducts(){
    ...
    const allProducts : {totalProductCount: number ; products: List_Product[] }= await this.productService.read(this.paginator ?
       this.paginator.pageIndex : 0, this.paginator ? this.paginator.pageSize :5, () => this.hideSpinner(SpinnerType.BallClimbingdot)
