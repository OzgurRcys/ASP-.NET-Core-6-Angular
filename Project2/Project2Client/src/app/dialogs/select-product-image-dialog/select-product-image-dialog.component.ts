...
export class SelectProductImageDialogComponent extends BaseDialog<SelectProductImageDialogComponent>  {
  ...
  constructor(dialogRef: MatDialogRef<SelectProductImageDialogComponent>,
    @Inject(MAT_DIALOG_DATA) public data: SelectProductImageState | string, private productService: ProductService, private spinner: NgxSpinnerService,
  ...
  async deleteImage(imageId: string, event: any){
    ...
    this.dialogService.openDialog({
      ...
      afterClosed: async () => {
        ...
        this.spinner.show(SpinnerType.BallClimbingdot)
        await this.productService.deleteImage(this.data as string, imageId, () => {this.spinner.hide(SpinnerType.BallClimbingdot);
